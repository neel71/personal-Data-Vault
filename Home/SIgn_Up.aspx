<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home_page.Master" AutoEventWireup="true" CodeBehind="SIgn_Up.aspx.cs" Inherits="PresentationLayer.Home.SIgn_Up" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset class="auto-style1">
                <legend  style="font-family: 'Times New Roman', Times, serif; color: #0000FF; font-size: 22px;">Registration<asp:Label ID="date" runat="server" CssClass="auto-style26" Font-Bold="True" Font-Size="Medium" ForeColor="Red"></asp:Label>
                ...
                <asp:TextBox ID="Textloginid" runat="server" CssClass="auto-style17" Font-Bold="True" ReadOnly="True" OnTextChanged="Textloginid_TextChanged"></asp:TextBox>
                <asp:Label ID="login" runat="server" Font-Bold="True" Font-Size="Medium" style="z-index: 1; left: 368px; top: 167px; position: absolute"></asp:Label>
                <asp:TextBox ID="Textpass" runat="server" CssClass="auto-style18" Font-Bold="True" TextMode="Password"></asp:TextBox>
                <asp:TextBox ID="Textcpass" runat="server" CssClass="auto-style19" Font-Bold="True" TextMode="Password" OnTextChanged="Textcpass_TextChanged"></asp:TextBox>
                ...
                <asp:Button ID="add" runat="server" BackColor="Blue" CssClass="auto-style23" Font-Bold="True" Font-Size="Large" ForeColor="White" Text="Add" OnClick="add_Click" />
                <asp:Button ID="clear" runat="server" BackColor="Blue" CssClass="auto-style24" Font-Bold="True" Font-Size="Large" ForeColor="White" Text="Clear" />
                <asp:DropDownList ID="ddgender" runat="server" CssClass="auto-style25" Font-Bold="True" Height="25px">
