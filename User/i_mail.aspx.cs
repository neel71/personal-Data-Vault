...
{
    public partial class i_mail1 : System.Web.UI.Page
    {
        ...
        public void filldata()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from compose where to_msg ='" + Session["id"] + "'", con);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                empty_gd.Text = "No Mails In Inbox......";
            }
        }
